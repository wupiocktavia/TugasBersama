...
<body>
			...
			<div id="body">
			       ...
			       <div id="content">
				        ...
				        <div class="content">
							<div class="about">
							<h2><a href=form_perawatan.php>Tambah Perawatan</a></h2>
							<h2><a href=form_detail_perawatan.php>Tambah Detail Perawatan</a></h2>
				...
				<li>
					...
					<table border=5>
						<?php include "koneksi.php";
							...
							$no=1;
							echo "<tr><td>Perawatan</td><td>Nama Hewan</td><td>Harga</td><td>Diskon</td></tr>";
							...
							{	
								...
								echo "<tr>";
								echo "<td>$data_perawatan[nama_perawatan]</td>
										<td>$data_perawatan[nama_kategori_hewan]</td>
										<td>$data_perawatan[harga_perawatan]</td>
										<td>$data_perawatan[diskon] %</td>";
								echo "</tr>";
							}
							$no++;
