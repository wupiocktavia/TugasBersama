			       ...
			       <div id="content">
				        ...
				        <div class="content">
							<div class="about">
                                 ...
                                 <ul>
									<li>
									<form method="post" action="pegawai_transaksi_hewan2.php" >
										<table align="center">
										<?PHP
										...
										<tr>
											...
											<td>
												<input name="id_hewan" type="text" value="" size="40" maxlength="40" placeholder="ID_001">
												<input type=submit value=Cek>
												<a href="keranjang_hewan.php?id_nota=<?php echo $id_nota;?>">Selesai</a>
											</td>
										</tr>
