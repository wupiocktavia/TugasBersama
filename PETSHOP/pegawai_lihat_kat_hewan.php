				...
				<li>
					...
					<table border=1 bgcolor=orange size=100% >
						<?php include "koneksi.php";
							...
							$no=1;
							echo "<tr><td>No</td><td>ID Kategori hewan</td><td>Nama Kategori hewan</td></tr>";
							...
							{	
								...
								echo "	<td width=25>$no</td>
										<td width=175>$data_kategori[id_kategori_hewan]</td>
										<td width=175>$data_kategori[nama_kategori_hewan]</td>";
