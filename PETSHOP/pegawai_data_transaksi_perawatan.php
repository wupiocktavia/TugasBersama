...
<div class="about">
	...
	<table width="100%"  align="center" border=3>
		...
		$tampil_perawatan=mysql_query("SELECT * FROM transaksi_perawatan ");
		$no=1;
		...
		{	?>
								<tr>
								<td><?PHP ECHO $no; ?></td>
										<td ><?PHP ECHO $data['id_nota_perawatan']; ?></td>
										<td><?PHP ECHO $data['id_user']; ?></td>
										<td ><?PHP ECHO $data['tgl_transaksi']; ?> </td>
										<td><?PHP ECHO $data['total_harga']; ?></td>
										<td><a href="pegawai_lihat_detail_transaksi_perawatan.php?id_nota=<?PHP ECHO $data['id_nota_perawatan']; ?>">Lihat Detail</a></td>
