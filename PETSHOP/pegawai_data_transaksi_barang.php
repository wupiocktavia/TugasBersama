...
<div class="about">
	...
	<table width="100%"  align="center" border=3>
		...
		$tampil_barang=mysql_query("SELECT * FROM transaksi_pembelian_barang ");
		$no=1;
		...
		{	?>
								...
								<td><?PHP ECHO $no; ?></td>
										...
										<td><a href="pegawai_lihat_detail_transaksi.php?id_nota=<?PHP ECHO $data['id_nota_barang']; ?>">Lihat Detail</a></td>
