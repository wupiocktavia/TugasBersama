...
$query = "SELECT id_nota_hewan, nama_lengkap, tgl_transaksi, total_harga FROM transaksi_pembelian_hewan JOIN USER USING (id_user) WHERE MONTH(tgl_transaksi)='$bulan' AND YEAR(tgl_transaksi)='$tahun'";
...
$judul = "LAPORAN DATA TRANSAKSI HEWAN BULAN $bln TAHUN $tahun";
$header = array(
