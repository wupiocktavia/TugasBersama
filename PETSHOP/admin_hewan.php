...
<?php include "header_admin.php"; ?>
	...
	<div class="about">
		...
		else
		{
			...
			{
			echo "<td>
					<a href=form_update_hewan.php?id_hewan=$data[id_hewan]><img src=images/tombol_update.jpg></a>
					</td>
					<td>
					<a href=form_tambah_stok_hewan.php?id_hewan=$data[id_hewan]><img src=images/tambah_stok.jpg></a>
				</td>";$n++;
			}
			echo "</tr>";
