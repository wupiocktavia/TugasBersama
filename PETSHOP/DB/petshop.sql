...
insert  into `detail_pembelian_hewan`(`id_nota_hewan`,`id_hewan`,`harga_hewan`,`diskon`,`kuantiti`,`subtotal`) values ('NH1',3,3200000,0.1,1,2980000),('NH1',6,50000,0,2,100000),('NH2',1,2500000,0.05,1,2375000),('NH3',6,50000,0,4,200000);
...
insert  into `detail_transaksi_perawatan`(`id_nota_perawatan`,`id_detail_perawatan`,`harga_perawatan`,`diskon`,`kuantiti`,`subtotal`) values ('NP1',1,25000,0,1,25000),('NP1',5,35000,0.05,1,33250),('NP2',8,50000,0.05,1,47500),('NP3',11,45000,0,1,45000),('NP3',1,25000,0,1,25000),('NP4',6,32500,0.05,1,30875);
...
insert  into `hewan`(`id_hewan`,`id_kategori_hewan`,`nama_hewan`,`direktori_gambar_hewan`,`harga_hewan`,`diskon`,`stok`) values (1,1,'Basenji','gambar/basenji.png',2500000,0.05,15),(2,3,'Munchkin','gambar/munchkin.jpg',1752500,0.05,15),(3,3,'Abyssinian','gambar/abyssinian.jpg',3200000,0.1,15),(4,1,'Doberman','gambar/doberman.jpg',5700000,0.07,15),(5,3,'Tiffany','gambar/kucing-tiffany.jpg',1500000,0,15),(6,2,'Roborovski','gambar/robo.jpg',50000,0,50);
...
insert  into `kategori_barang`(`id_kategori_barang`,`nama_kategori_barang`) values (1,'Baju'),(2,'Pita'),(3,'Sepatu'),(4,'Tempat Makan'),(5,'Topi'),(6,'Tempat Tidur'),(7,'Serokan');
...
insert  into `kategori_hewan`(`id_kategori_hewan`,`nama_kategori_hewan`) values (1,'Anjing'),(2,'Hamster'),(3,'Kucing');
...
insert  into `perawatan`(`id_perawatan`,`nama_perawatan`) values (1,'Mandi'),(2,'Potong Kuku'),(3,'Cukur'),(4,'Pijat'),(5,'Salon'),(6,'Renang');
...
insert  into `transaksi_pembelian_hewan`(`id_nota_hewan`,`id_user`,`tgl_transaksi`,`total_harga`) values ('NH1','M7','2014-01-05',2980000),('NH2','M2','2014-01-05',2375000),('NH3','M4','2014-01-06',200000);
...
insert  into `transaksi_perawatan`(`id_nota_perawatan`,`id_user`,`tgl_transaksi`,`total_harga`) values ('NP1','M2','2014-01-05',58250),('NP2','M4','2014-01-05',47500),('NP3','M1','2014-01-06',70000),('NP4','M4','2014-01-06',30875);
