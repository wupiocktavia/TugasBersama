...
<div class="about">
	...
	<?php 
		...
		$query=mysql_query("SELECT * from transaksi_perawatan join user using(id_user) where id_nota_perawatan='$id_nota'");
	...
	<table border=1 width="100%">
		...
		echo "<tr><td>NO</td><td>Id Detail Perawatan</td><td>Harga perawatan</td><td>Diskon</td><td>Kuantiti</td><td>Subtotal</td></tr>";
		...
		<?php
			$a=mysql_query("SELECT total_harga from transaksi_perawatan where id_nota_perawatan='$id_nota'");
	...
	<table>
	<tr><td colspan=8><a href="pegawai_data_transaksi_perawatan.php"><img src="images/back.png" width=40 height=40 align=right></a></td></tr>		
	</table>
	</form>
	</li>
	</ul>							
